...
public class Product {
	...
	// default constructor will automatically load when product created and generate a code for it
	public Product() {
		
		this.code = "NIR" + UUID.randomUUID().toString().substring(26).toUpperCase();
	}
